# Docker ELK stack with Machine Learning Stack
...
Below is the sample data sets that can be used in ELK stack for basic monitoring and Machine Learning practice .
```console
$ nc localhost 5000 < /Docker-ELK-with-ML/elasticsearch/server-metrics_1.json
$ nc localhost 5000 < /Docker-ELK-with-ML/elasticsearch/server-metrics_2.json
$ nc localhost 5000 < /Docker-ELK-with-ML/elasticsearch/server-metrics_3.json
$ nc localhost 5000 < /Docker-ELK-with-ML/elasticsearch/server-metrics_4.json
```
...
## Machine Learning with the stack

Please refer to the link below to setup the Machine learning stack and learn the usage .

Data Sets has been uploaded above in logstash container in "Usage Section" .

Create default index pattern in Kibana and data will be shown.

Follow the instructions 
[Getting started with Machine Leaning](https://www.elastic.co/guide/en/x-pack/current/ml-getting-started.html)
